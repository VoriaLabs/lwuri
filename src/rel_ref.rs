...
mod tests {
    ...
    fn path() {
        assert_eq!(
            rel_ref!("example/"),
            rel_ref!("example/").path_as_rel_ref()
        );
        assert_eq!(
    ...
    fn avoid_scheme_confusion() {
        ...
        assert_eq!(
            None,
            rel_ref!("%20this:that").colon_in_first_path_segment()
        );
        assert_eq!(
            Some(4),
        ...
        assert_eq!(
            None,
            rel_ref!(unsafe "this:that").to_uri_ref_buf().scheme()
        );
    ...
    fn trim_leading_path_segment() {
        ...
        assert_eq!(
            ("", rel_ref!("")),
            rel_ref!("").trim_leading_path_segment()
        );
    }
