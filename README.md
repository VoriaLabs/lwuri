...
[![Build Status](https://travis-ci.org/vorialabs/lwuri.svg?branch=master)](https://travis-ci.org/vorialabs/lwuri)
[![Crates.io](https://img.shields.io/crates/v/lwuri.svg)](https://crates.io/crates/lwuri)
[![API](https://docs.rs/lwuri/badge.svg)](https://docs.rs/lwuri)
...
See the [crate documentation](https://docs.rs/lwuri) for more information.
...
lwuri is released under the [Apache 2.0 license](../LICENSE).
...
This project was based on `async-coap-uri`.
